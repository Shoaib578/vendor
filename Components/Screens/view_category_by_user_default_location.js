...
import {View,Text,Dimensions,Image,TouchableOpacity,StyleSheet,TextInput,Alert} from 'react-native'
...
class ViewCategoryByUserDefaultLocation extends React.Component {
    state = {
        all_vendors: [],
        category_info:[],
        search_box:'',
      ...
      getVendors_and_CategoryInfo = async()=> {
        const user =await AsyncStorage.getItem('user')
        const parse = JSON.parse(user)

        Axios.get(base_url+'view_category_by_user_default_location?category_id='+this.props.route.params.id+'&&user_default_location='+parse.user_cityname)
        .then(res=>{
...
export default ViewCategoryByUserDefaultLocation